    ...
    <div class="ratings-content">
      <div class="overview">
        <div class="overview-left">
          ...
          <div class="rank">高于周边商家{{seller.rateRate}}%</div>
        </div>
      ...
      <split></split>
      <ratingselect :select-type="selectType" :only-content="onlyContent" :ratings="ratings" v-on:changeSelectType="changeSelectType"
